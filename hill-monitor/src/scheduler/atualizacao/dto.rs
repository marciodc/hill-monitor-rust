...
pub struct NewProduto {
    ...
    pub ativo: bool,
    pub vendivel: Option<bool>,
    pub categoria_id: Option<i32>,
    pub situacao_tributaria_id: Option<i32>,
    pub ultimo_fornecedor_id: Option<i32>,
    pub ultima_compra_em: Option<String>,
    pub codigo_barras: Option<String>,
    pub codigo: String,
    pub nome: String,
    pub descricao: Option<String>,
    pub unidade: Option<String>,
    pub preco_custo: Option<String>,
    pub estoque_atual: Option<String>,
    pub estoque_minimo: Option<String>,
    pub ncm: Option<String>,
    pub cest: Option<String>,
    pub cfop_saida_padrao: Option<String>,
    pub origem: Option<i32>,
    pub is_combustivel: bool,
    pub tipo_combustivel: Option<String>,
    pub anp_codigo: Option<String>,
    pub densidade_referencia: Option<String>,
    pub preco_venda: Option<String>,
    pub unidade_tributavel: Option<String>,
    pub fator_conversao: Option<String>,
    pub controla_lote: Option<bool>,
    pub controla_validade: Option<bool>,
    pub eh_kit: Option<bool>,
    ...
    pub mva_override: Option<String>,
    pub bc_st_retido_unit: Option<String>,
    pub icms_st_retido_unit: Option<String>,
    pub icms_substituto_unit: Option<String>,
    pub fcp_st_retido_unit: Option<String>,
    pub cst_cbs: Option<String>,
    pub cst_ibs: Option<String>,
    pub cbs_regime: Option<String>,
    pub ibs_regime: Option<String>,
    pub cbs_aliquota_pct: Option<String>,
    pub ibs_aliquota_pct: Option<String>,
    pub is_aliquota_pct: Option<String>,
    pub cbs_ad_rem_por_litro: Option<String>,
    pub ibs_ad_rem_por_litro: Option<String>,
    pub is_ad_rem_por_litro: Option<String>,
